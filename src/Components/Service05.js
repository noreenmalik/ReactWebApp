...
import SIcon from './Sub-Services/5-icon-loaded-crane.svg';
...
const Service05 = () => {
  ...
  return (
      ...
      <>
           ...
           <div className="service05-header_wrapper">
       <Navbar/>
        ...
        <div className="container pb-md-3 pt-5 mt-5">
          <div className="row d-flex justify-content-center align-items-center text-center">
            <div className="col mt-md-2 pt-md-2">
              ...
              <h1 className='heading-4 headerfont pb-0 mb-0'>Construction and Infrastructure</h1>
                <ol className="breadcrumb d-flex justify-content-center align-items-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item"><a href="/services">Services</a></li>
                 < li class="breadcrumb-item active"><a href="">Construction and Infrastructure</a></li>
                </ol>
                </div>
            </div>
        ...
        <div className="container d-flex justify-content-center py-5" >
          <div className="row justify-content-center">
            ...
            <div className='service-Sec2_wapper col-lg-8 col-md-10 col-sm-12 '>
              <p>LegalVision’s construction lawyers has an established reputation in Australia’s construction and infrastructure space, and assists:</p>
              <ul>
                <li>owners and developers with:</li>
                <ul>
                  <li>selecting procurement strategies to best suit their needs;</li>
                  <li>preparing tender documentation and reviewing tender responses;</li>
                  <li>preparing, reviewing or negotiating construction contracts (including consultancy contracts, construct-only contracts, design-and-construct contracts, supply contracts, logistics contracts and project management contracts); and</li>
                  <li>administering construction contracts, including the review and assessment of contractual claims; and</li>

                </ul>
                <li>contractors, subcontractors, suppliers, consultants, certifiers, project managers and logistics providers with:</li>
                <ul>
                  <li>preparing, reviewing or negotiating construction contracts, including</li>
                  <li>preparing downstream suites of contracts; and</li>
                  <li>administering construction contracts, including the preparation of contractual claims.</li>

                </ul>
              </ul>
  
              <p>Whether you operate in the property development sector (residential, commercial or industrial) or the infrastructure sector (rail, roads, hospitals, schools, prisons, energy or resources), our team has the experience and the expertise to help you navigate your way through any project, in a cost-effective and commercial manner.</p>
