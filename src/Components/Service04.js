...
import SIcon from './Sub-Services/4-icon-two-document-sheet-outline-with-plus-symbol.svg';
...
const Service04 = () => {
  ...
  return (
      ...
      <>
           ...
           <div className="service04-header_wrapper">
        <Navbar/>
        ...
        <div className="container pb-md-3 pt-5 mt-5">
          <div className="row d-flex justify-content-center align-items-center text-center">
            <div className="col mt-md-2 pt-md-2">
              ...
              <h1 className='heading-4 headerfont pb-0 mb-0'>Commercial Contracts</h1>
                <ol className="breadcrumb d-flex justify-content-center align-items-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item"><a href="/services">Services</a></li>
                 < li class="breadcrumb-item active"><a href="">Commercial Contracts</a></li>
                </ol>
                </div>
            </div>
        ...
        <div className="container d-flex justify-content-center py-5" >
          <div className="row justify-content-center">
            ...
            <div className='service-Sec2_wapper col-lg-8 col-md-10 col-sm-12 '>
              <p>Businesses enter into new contracts each day – including with customers, suppliers and employees. Before entering into a contract, you should make sure it has been reviewed by a specialist lawyer.</p>
              <p>At LegalVision, we help clients review a wide range of contracts, including:</p>
              <ul>
                <li>shareholders agreements;</li>
                <li>franchise agreements;</li>
                <li>sale of business agreements;</li>
                ...
                <li>distribution and supply agreements; and</li>
                <li>licence agreements.</li>
              </ul>
  
              <p>In addition to contract reviews and negotiations, LegalVision can also help draft contracts for your business and resolve contractual disputes. If you need assistance drafting contracts for your business, reach out to our team of expert contract lawyers.</p>
