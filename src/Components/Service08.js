...
import SIcon from './Sub-Services/8-icon-lifebuoy.svg';
...
const Service08 = () => {
  ...
  return (
      ...
      <>
           ...
           <div className="service08-header_wrapper">
          <Navbar/>
        ...
        <div className="container pb-md-3 pt-5 mt-5">
          <div className="row d-flex justify-content-center align-items-center text-center">
            <div className="col mt-md-2 pt-md-2">
              ...
              <h1 className='heading-4 headerfont pb-0 mb-0'>Dispute Resolution and Litigation</h1>
                <ol className="breadcrumb d-flex justify-content-center align-items-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item"><a href="/services">Services</a></li>
                 < li class="breadcrumb-item active"><a href="">Dispute Resolution and Litigation</a></li>
                </ol>
                </div>
            </div>
        ...
        <div className="container d-flex justify-content-center py-5" >
          <div className="row justify-content-center">
            ...
            <div className='service-Sec2_wapper col-lg-8 col-md-10 col-sm-12 '>
              <p>Commercial disputes are common – and, as your business grows, it’s likely that you’ll run into a dispute with a competitor, supplier, customer, employee or even a business partner. Whether it is an intellectual property dispute in the financial services industry or a product liability litigation class action, disputes are common in business.</p>
              <p>However, some legal disputes can take significant time and resources away from a business – particularly where the dispute leads to litigation. Litigation is the process of dealing with a dispute in a court or tribunal. Other ways of dealing with disputes include negotiation to reach a commercial settlement, “alternative dispute resolution (ADR)” (including mediation, conciliation and arbitration) and “external dispute resolution” (such as ombudsman services). Some businesses also use “internal dispute resolution” procedures, like a customer complaints process for an online retailer.</p>
  
              <p>LegalVision’s disputes team can help resolve your dispute at the early stages, so that you can focus on what’s most important for your business. When necessary, our Australian litigation lawyers and litigators also draw on their experience to assist clients involved in commercial litigation and other forms of dispute resolution. As a commercial law firm, we have assisted clients in civil litigation in the Federal Court, Supreme Court and High Court across all Commonwealth jurisdictions.</p>
