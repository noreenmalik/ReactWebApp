...
const Service18 = () => {
  ...
  return (
      ...
      <>
           ...
           <div className="service18-header_wrapper">
           <Navbar/>
        ...
        <div className="container pb-md-3 pt-5 mt-5">
          <div className="row d-flex justify-content-center align-items-center text-center">
            <div className="col mt-md-2 pt-md-2">
              ...
              <h1 className='heading-4 headerfont pb-0 mb-0'>Restructuring and Insolvency</h1>
                <ol className="breadcrumb d-flex justify-content-center align-items-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item"><a href="/services">Services</a></li>
                 < li class="breadcrumb-item active"><a href="">Restructuring and Insolvency</a></li>
                </ol>
                </div>
            </div>
        ...
        <div className="container d-flex justify-content-center py-5" >
          <div className="row justify-content-center">
            ...
            <div className='service-Sec2_wapper col-lg-8 col-md-10 col-sm-12 '>
              <p>LegalVision's restructuring and insolvency team can assist you in dealing with the processes surrounding each stage of the personal or corporate insolvency process.</p>
              <p>LegalVision's restructuring and insolvency team can assist you in dealing with the processes surrounding each stage of the personal or corporate insolvency process.Whether you are a creditor seeking assistance in the recovery of a debt from an individual or a company, an individual looking for a personal insolvency agreement to avoid a formal bankruptcy,  or a director of a company in voluntary administration and are asking creditors to compromise their rights and enter into a deed of company arrangement, LegalVision can provide prompt and cost-effective advice and assistance.</p>
              
  
              <p>LegalVision's lawyers have a broad range of experience within the insolvency and restructuring industry. If you would like to request assistance with a personal or corporate insolvency matter, get in touch with our team today.</p>
