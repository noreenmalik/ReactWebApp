...
import SIcon from './Sub-Services/14-icon-light-bulb.svg';
...
const Service14 = () => {
  ...
  return (
      ...
      <>
           ...
           <div className="service14-header_wrapper">
           <Navbar/>
        ...
        <div className="container pb-md-3 pt-5 mt-5">
          <div className="row d-flex justify-content-center align-items-center text-center">
            <div className="col mt-md-2 pt-md-2">
              ...
              <h1 className='heading-4 headerfont pb-0 mb-0'>Intellectual Property</h1>
                <ol className="breadcrumb d-flex justify-content-center align-items-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item"><a href="/services">Services</a></li>
                 < li class="breadcrumb-item active"><a href="">Intellectual Property</a></li>
                </ol>
                </div>
            </div>
        ...
        <div className="container d-flex justify-content-center py-5" >
          <div className="row justify-content-center">
            ...
            <div className='service-Sec2_wapper col-lg-8 col-md-10 col-sm-12 '>
              <p>For many businesses, your brand will be a crucial part of the identity of your business. Customers will often identify your business by reference to your logo, slogan, colour scheme or even a distinctive sound. The best way to protect these distinctive elements of your brand and intellectual property is by obtaining a registered trade mark. It is possible to trade without obtaining registration for these elements of your brand. However, by obtaining a registered trade mark you will have a record of the date on which you began using a trade mark, the exact mark you have registered, and the classes in which you have obtained registration. This can be very advantageous when seeking to assert or enforce your exclusive rights against others who use marks that are similar to yours. A business name or domain name is insufficient to protect your brand name – you must lodge a trademark application for full trademark protection.</p>
              <p>LegalVision’s trade mark lawyers can assist you with:</p>
              <ul>
                <li>trade mark registration in Australia and overseas (direct application and Madrid Protocol);</li>
                <li>responding to a trade mark opposition on your behalf as the trademark owner;</li>
                <li>defending a trade mark infringement claim and IP dispute resolution;</li>
                <li>renewing an Australian trade mark, paying renewal fees; and</li>
                <li>lodging a trade mark infringement.</li>
              </ul>
  
              <p>Registering a trade mark can be a lengthy process with IP Australia (Australia’s trademark office). It involves classifying your brand into one of IP Australia’s 45 classes and conducting a comprehensive trade mark search before making your application. Our IP lawyers provide trademark services and have successfully completed the registration process for hundreds of trade marks in Australia as well as international trade marks and can assist you with your application. We have deep industry experience in the application process and relevant domestic and international trademark laws.</p>
