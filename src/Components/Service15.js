...
import SIcon from './Sub-Services/15-icon-person-with-headset.svg';
...
const Service15 = () => {
  ...
  return (
      ...
      <>
           ...
           <div className="service15-header_wrapper">
           <Navbar/>
        ...
        <div className="container pb-md-3 pt-5 mt-5">
          <div className="row d-flex justify-content-center align-items-center text-center">
            <div className="col mt-md-2 pt-md-2">
              ...
              <h1 className='heading-4 headerfont pb-0 mb-0'>Media and Entertainment</h1>
                <ol className="breadcrumb d-flex justify-content-center align-items-center">
                  <li className="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item"><a href="/services">Services</a></li>
                 < li class="breadcrumb-item active"><a href="">Media and Entertainment</a></li>
                </ol>
                </div>
            </div>
        ...
        <div className="container d-flex justify-content-center py-5" >
          <div className="row justify-content-center">
            ...
            <div className='service-Sec2_wapper col-lg-8 col-md-10 col-sm-12 '>
              <p>LegalVision’s media and entertainment team are experienced with the commercial and regulatory environment in which media and entertainment businesses operate. We can assist:</p>
              <ul>
                <li>content creators with distribution, defamation claims and intellectual property protection (including licensing, commercialisation and enforcement);</li>
                <li>individuals and businesses with contract reviews, drafting and negotiation;</li>
                <li>producers with film and media financing, production and commercialisation of content;</li>
                <li>advertising and marketing agencies with advertising compliance; and</li>
                <li>publishing companies with strategic commercial legal advice on rights and distribution.</li>
              </ul>
  
              <p>Our media and entertainment lawyers have worked with entertainment and media companies, financiers, creators and distributors. We combine legal expertise and industry knowledge with technical know-how to deliver specialist advice in this sector. We can also assist with business structuring and employment law as it applies to the media, arts and entertainment space.</p>
